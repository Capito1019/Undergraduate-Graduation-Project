...
def main():
    ...
    output_file_path = "/data/capito/a_bishe/LoRA_infer/cpp_LoRA_fixed_tasks.json"  # 纯二维列表格式
    used_json_path = "/data/capito/a_bishe/LoRA_infer/cpp_LoRA_used_tasks.json"  # 记录已处理的 task_id
