...
def main():
    # 设定 JSON 文件路径
    json_file_path = "/data/capito/a_bishe/bench/js_humanevalpack.jsonl" 
    output_file_path = "/data/capito/a_bishe/codellama_infer/js_fixed_tasks.json"  # 纯二维列表格式
    used_json_path = "/data/capito/a_bishe/codellama_infer/js_used_tasks.json"  # 记录已处理的 task_id
